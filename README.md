# King-Crawl 
<img width="100" height="1200" alt="image" src="https://github.com/user-attachments/assets/d72a0ac6-51db-49fd-8e5b-8a0a1be87292" />

*A dungeon crawler card game played with a standard 52 card deck*

# Setup and Basic Rules
1. Shuffle the deck and place face-down
2. Players take turns drawing the top card and placing face-up at the center of the table
3. The card drawn determines the next action
     Number cards - Can be taken into the player's hand or swapped for a card in the player's hand
